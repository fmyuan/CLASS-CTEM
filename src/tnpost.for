     ...
     2                  TBASE,A1,A2,B1,B2,C2,FCT,IWATER,DELZ,DELZW,
     3                  ILG,IL1,IL2,JL,IG                     )
C
...
C
      REAL ZPOND (ILG),    TSURF (ILG),    TBASE (ILG),    A1    (ILG),
     1     A2    (ILG),    B1    (ILG),    B2    (ILG),    C2    (ILG),
     2     FCT   (ILG),    GCONST(ILG),    GCOEFF(ILG)
C
      INTEGER              IWATER(ILG)
C
      REAL DELZ  (IG)
...
C
      DO 200 I=IL1,IL2
          IF(FCT(I).GT.0.)                                          THEN
              ...
              G12(I)=(TSURF(I)-TBAR(I,1)-A1(I)*GZROLD)/B1(I)
